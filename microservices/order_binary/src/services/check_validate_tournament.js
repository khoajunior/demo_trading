...
const { TOURNAMENT_DELETE_STATUS, OPTION_BINARY_TRADE, FOREX_TYPE } = require('../../constants/constants')
...
module.exports = (item, check_min_amount = false, check_max_amount = false) => new Promise(async(resolve, reject) => {
    try {
        ...
        let quantity = item.investment || 0
        ...
        const variables = {
            ...
            tournament_id_list,
            option_trade: OPTION_BINARY_TRADE,
        }
