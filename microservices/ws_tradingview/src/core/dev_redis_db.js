...
const { REDIS_HOST, REDIS_PORT, REDIS_PASSWORD, MICROSERVICE_NAME, DEV_REDIS_URL} = require('../../constants/constants')
...
const connect = () => {
    try {
        ...
        const client = redis.createClient(DEV_REDIS_URL, {
        ...
        console.log(`REDIS: connect to ${DEV_REDIS_URL} success`)
