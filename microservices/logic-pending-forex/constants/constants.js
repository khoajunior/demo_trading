module.exports = {
    ...
    MICROSERVICE_NAME: process.env.MICROSERVICE_NAME || 'LOGIC_PENDING_FOREX',
    ...
    // EXCHANGE_LOGIC_SERVICE:  'offline-pending-forex',

    CHUNK_USER_LIST: process.env.CHUNK_USER_LIST || 1,
    PICE_USER_LIST: process.env.PICE_USER_LIST || 1,
    CHUNK_SERCVICE_NAME: process.env.CHUNK_SERCVICE_NAME || 'chunk_online_pending_forex_service_1',
